...
export class AssuranceComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-assurance div table .btn-danger'));
  title = element.all(by.css('jhi-assurance div h2#page-heading span')).first();
...
export class AssuranceUpdatePage {
  pageTitle = element(by.id('jhi-assurance-heading'));
...
export class AssuranceDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-assurance-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-assurance'));
