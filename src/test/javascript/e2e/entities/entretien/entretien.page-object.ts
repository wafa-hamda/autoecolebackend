...
export class EntretienComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-entretien div table .btn-danger'));
  title = element.all(by.css('jhi-entretien div h2#page-heading span')).first();
...
export class EntretienUpdatePage {
  pageTitle = element(by.id('jhi-entretien-heading'));
...
export class EntretienDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-entretien-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-entretien'));
