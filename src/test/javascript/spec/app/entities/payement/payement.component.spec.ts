...
import { PayementComponent } from 'app/entities/payement/payement.component';
  ...
  describe('Payement Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PayementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.payements && comp.payements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
