...
import { IEntretien, Entretien } from 'app/shared/model/entretien.model';
...
describe('Service Tests', () => {
  describe('Entretien Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Entretien(0, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Entretien', () => {
        ...
        service.create(new Entretien()).subscribe(resp => (expectedResult = resp.body));
