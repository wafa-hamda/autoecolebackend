...
import { EntretienComponent } from 'app/entities/entretien/entretien.component';
...
describe('Component Tests', () => {
  describe('Entretien Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.entretiens && comp.entretiens[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
