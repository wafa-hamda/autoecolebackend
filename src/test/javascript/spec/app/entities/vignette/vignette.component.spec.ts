...
import { VignetteComponent } from 'app/entities/vignette/vignette.component';
...
describe('Component Tests', () => {
  describe('Vignette Management Component', () => {
    let comp: VignetteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VignetteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.vignettes && comp.vignettes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
