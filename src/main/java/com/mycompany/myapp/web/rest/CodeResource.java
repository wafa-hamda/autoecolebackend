...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Code}.
 */
@RestController
@RequestMapping("/api")
public class CodeResource {
     ...
     */
    @PostMapping("/codes")
    public ResponseEntity<Code> createCode(@RequestBody Code code) throws URISyntaxException {
     ...
     */
    @PutMapping("/codes")
    public ResponseEntity<Code> updateCode(@RequestBody Code code) throws URISyntaxException {
    ...
    public ResponseEntity<List<Code>> getAllCodes(Pageable pageable) {
        ...
        Page<Code> page = codeService.findAll(pageable);
